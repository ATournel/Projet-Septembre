...
/**
 * Servlet implementation class ChangerPeutEtreServlet
 */
@WebServlet("/ChangerPeutEtreServlet")
public class ChangerPeutEtreServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ChangerPeutEtreServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement ps = (PreparedStatement) cn
					.prepareStatement("UPDATE participant SET presence='peut-être' WHERE mail_participant='" + login
